...
<section class="orders">
   <div class="contain"><a href="pre_orders.php" class="option-btn">For Pre Orders</a></div>
   ...
   <table>
      ...
      <?php
      $cur_date=date('Y-m-d');
      $select_orders = mysqli_query($conn, "SELECT * FROM `order_tbl` WHERE order_date LIKE '$cur_date%' ORDER BY order_taken, order_date") or die('query failed');
