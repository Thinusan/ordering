...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="sub-total"> sub total : <span>Rs<?php echo $sub_total = ($fetch_cart_tbl['quantity'] *($fetch_cart_tbl['t_price']+ $fetch_cart_tbl['p_price'])); ?>/-</span> </div>
      </div>
      <?php
   ...
   <div class="add-more">
      <a href="orders2.php" class="add-more-btn">Add more food items</a>
   </div>
   ...
   <div class="cart-total">
      ...
      <div class="flex">
         <a href="order_details.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Order</a>
      </div>
